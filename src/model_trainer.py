...
class ModelTrainer:
    ...
    def tune_linear_logistic_elasticnet_regression(self, model, X_train, y_train, model_name, model_parameters):
        params = {"random_state": self.random_state}
        if model_parameters[model_name].get("random_state"):
            params["random_state"] = model_parameters[model_name]["random_state"]
    ...
    def tune_svm(self, model, X_train, y_train, model_parameters):
        params = {"random_state": self.random_state}
        if model_parameters["SVM"].get("random_state"):
            params["random_state"] = model_parameters["SVM"]["random_state"]
    ...
    def tune_knn(self, model, X_train, y_train, model_parameters):
        params = {"random_state": self.random_state}
        if model_parameters["KNN"].get("random_state"):
            params["random_state"] = model_parameters["KNN"]["random_state"]
    ...
    def tune_xgb(self, model, X_train, y_train, model_name, model_parameters):
        ...
        if model_parameters["XGB"].get("random_state"):
            params["random_state"] = model_parameters["XGB"]["random_state"]
    ...
    def build_and_tune_model(self, X_train, y_train, problem_type, selected_models, model_parameters):
        ...
        for model_name in selected_models:
            ...
            if (model_name == "RandomForestClassifier" or model_name == "RandomForestRegressor"):
                ...
                best_model = self.tune_linear_logistic_elasticnet_regression(model, X_train, y_train, model_name, model_parameters)
